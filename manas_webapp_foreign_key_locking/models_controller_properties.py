...
class ControllerProperties (models.Model, GenBase):
    ...
    @staticmethod
    def gen_uuid(id=1):
        return 'controllerproperties-%s' % uuid.uuid4()
    ...
    def save(self, update_time=False, *args, **kwargs):
        ...
        super(ControllerProperties, self).save(*args, **kwargs)
    ...
    def delete(self):
        ...
        super(ControllerProperties, self).delete()

    def serialize(self):
        return self.protobuf().SerializeToString()

    def _protobuf(self):
        pb = ControllerPropertiesProto()

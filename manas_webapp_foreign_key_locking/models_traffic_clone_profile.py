...
class TrafficCloneProfile (models.Model, GenBase):
    ...
    @staticmethod
    def gen_uuid(id=1):
        return 'trafficcloneprofile-%s' % uuid.uuid4()
    ...
    def save(self, update_time=False, *args, **kwargs):
        ...
        super(TrafficCloneProfile, self).save(*args, **kwargs)
    ...
    def delete(self):
        ...
        super(TrafficCloneProfile, self).delete()

    def serialize(self):
        return self.protobuf().SerializeToString()

    def _protobuf(self):
        pb = TrafficCloneProfileProto()
    ...
    tenant_ref = models.ForeignKey(Tenant, null=False, blank=False, related_name="trafficcloneprofile_tenant_ref", on_delete=models.PROTECT)
    cloud_ref = models.ForeignKey(Cloud, null=True, blank=True, related_name="trafficcloneprofile_cloud_ref", on_delete=models.PROTECT)
    _last_modified = models.CharField(max_length=16, null=True, blank=True)

    references = {
        'root.clone_servers.network_uuid': ('hyperlink_to', u'Network', 'd47d7d6ececc47b2'),
        'root.tenant_uuid': ('belongs_to', u'Tenant', '8da438290551420e'),
        'root.cloud_uuid': ('belongs_to', u'Cloud', 'c2d4ab1dde434311'),
    }
    sensitive_fields = {
    }
    pb_check_fields = {

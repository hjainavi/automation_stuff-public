...
class SecurityPolicy (models.Model, GenBase):
    ...
    @staticmethod
    def gen_uuid(id=1):
        return 'securitypolicy-%s' % uuid.uuid4()
    ...
    def save(self, update_time=False, *args, **kwargs):
        ...
        super(SecurityPolicy, self).save(*args, **kwargs)
    ...
    def delete(self):
        ...
        super(SecurityPolicy, self).delete()

    def serialize(self):
        return self.protobuf().SerializeToString()

    def _protobuf(self):
        pb = SecurityPolicyProto()
    ...
    tenant_ref = models.ForeignKey(Tenant, null=True, blank=True, related_name="securitypolicy_tenant_ref", on_delete=models.PROTECT)
    _last_modified = models.CharField(max_length=16, null=True, blank=True)

    references = {
        'root.tenant_uuid': ('belongs_to', u'Tenant', 'b796d14dfd634f47'),
    }
    sensitive_fields = {
    }
    pb_check_fields = {

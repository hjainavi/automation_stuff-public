...
NSX_MGR_POST = 3
NSX_MGR_DEL = 4
NSX_MGR_ALL_REST_API = 5
NSX_FAULT_APIChoices = (
    (NSX_MGR_GET, 'NSX_MGR_GET'),
    (NSX_MGR_PUT, 'NSX_MGR_PUT'),
    (NSX_MGR_POST, 'NSX_MGR_POST'),
    (NSX_MGR_DEL, 'NSX_MGR_DEL'),
    (NSX_MGR_ALL_REST_API, 'NSX_MGR_ALL_REST_API'),
)

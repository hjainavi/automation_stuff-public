...
class Backup (models.Model, GenBase):
    ...
    tenant_ref = models.ForeignKey(Tenant, null=True, blank=True, related_name="backup_tenant_ref", on_delete=models.PROTECT)
    _last_modified = models.CharField(max_length=16, null=True, blank=True)

    references = {
        'root.scheduler_uuid': ('hyperlink_to', u'Scheduler', '84c157e403dc4475'),
        'root.tenant_uuid': ('belongs_to', u'Tenant', '421e86d1002248d5'),
        'root.backup_config_uuid': ('hyperlink_to', u'BackupConfiguration', '69baa83823c7450f'),
    }
    sensitive_fields = {
    }
    pb_check_fields = {

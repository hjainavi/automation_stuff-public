...
class CloudProperties (models.Model, GenBase):
    ...
    @staticmethod
    def gen_uuid(id=1):
        return 'cloudproperties-%s' % uuid.uuid4()
    ...
    def save(self, update_time=False, *args, **kwargs):
        ...
        super(CloudProperties, self).save(*args, **kwargs)
    ...
    def delete(self):
        ...
        super(CloudProperties, self).delete()

    def serialize(self):
        return self.protobuf().SerializeToString()

    def _protobuf(self):
        pb = CloudPropertiesProto()
    ...
    sensitive_fields = {
        'root.info.controller_props.portal_token',
    }
    pb_check_fields = {
    }

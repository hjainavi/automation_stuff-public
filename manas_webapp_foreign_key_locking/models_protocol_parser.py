...
class ProtocolParser (models.Model, GenBase):
    ...
    @staticmethod
    def gen_uuid(id=1):
        return 'protocolparser-%s' % uuid.uuid4()
    ...
    def save(self, update_time=False, *args, **kwargs):
        ...
        super(ProtocolParser, self).save(*args, **kwargs)
    ...
    def delete(self):
        ...
        super(ProtocolParser, self).delete()

    def serialize(self):
        return self.protobuf().SerializeToString()

    def _protobuf(self):
        pb = ProtocolParserProto()
    ...
    tenant_ref = models.ForeignKey(Tenant, null=True, blank=True, related_name="protocolparser_tenant_ref", on_delete=models.PROTECT)
    _last_modified = models.CharField(max_length=16, null=True, blank=True)

    references = {
        'root.tenant_uuid': ('belongs_to', u'Tenant', '46e6619c58ec45f2'),
    }
    sensitive_fields = {
    }
    pb_check_fields = {

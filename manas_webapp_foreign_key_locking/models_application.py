...
class Application (models.Model, GenBase):
    ...
    @staticmethod
    def gen_uuid(id=1):
        return 'application-%s' % uuid.uuid4()
    ...
    tenant_ref = models.ForeignKey(Tenant, null=False, blank=False, related_name="application_tenant_ref", on_delete=models.PROTECT)
    _last_modified = models.CharField(max_length=16, null=True, blank=True)

    references = {
        'root.virtualservice_uuids': ('refers_to', u'VirtualService', 'a129c7d524ff48ec'),
        'root.tenant_uuid': ('belongs_to', u'Tenant', 'e1515a89c8a5434c'),
    }
    sensitive_fields = {
    }
    pb_check_fields = {

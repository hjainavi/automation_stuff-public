...
class MicroService (models.Model, GenBase):
    ...
    @staticmethod
    def gen_uuid(id=1):
        return 'microservice-%s' % uuid.uuid4()
    ...
    def save(self, update_time=False, *args, **kwargs):
        ...
        super(MicroService, self).save(*args, **kwargs)
    ...
    def delete(self):
        ...
        super(MicroService, self).delete()

    def serialize(self):
        return self.protobuf().SerializeToString()

    def _protobuf(self):
        pb = MicroServiceProto()
    ...
    tenant_ref = models.ForeignKey(Tenant, null=False, blank=False, related_name="microservice_tenant_ref", on_delete=models.PROTECT)
    _last_modified = models.CharField(max_length=16, null=True, blank=True)

    references = {
        'root.tenant_uuid': ('belongs_to', u'Tenant', 'b83929e0f01d4849'),
    }
    sensitive_fields = {
    }
    pb_check_fields = {

...
class PingAccessAgent (models.Model, GenBase):
    ...
    @staticmethod
    def gen_uuid(id=1):
        return 'pingaccessagent-%s' % uuid.uuid4()
    ...
    def save(self, update_time=False, *args, **kwargs):
        ...
        super(PingAccessAgent, self).save(*args, **kwargs)
    ...
    def delete(self):
        ...
        super(PingAccessAgent, self).delete()

    def serialize(self):
        return self.protobuf().SerializeToString()

    def _protobuf(self):
        pb = PingAccessAgentProto()
    ...
    tenant_ref = models.ForeignKey(Tenant, null=True, blank=True, related_name="pingaccessagent_tenant_ref", on_delete=models.PROTECT)
    pingaccess_pool_ref_5d175f2a51b34d31_ref = models.ForeignKey(Pool, null=True, blank=True, related_name="pingaccessagent_pingaccess_pool_ref_5d175f2a51b34d31", on_delete=models.PROTECT)
    _last_modified = models.CharField(max_length=16, null=True, blank=True)

    references = {
        'root.pingaccess_pool_uuid': ('refers_to', u'Pool', '5d175f2a51b34d31'),
        'root.tenant_uuid': ('belongs_to', u'Tenant', 'e26fdbe9f2534815'),
    }
    sensitive_fields = {
    }
    pb_check_fields = {

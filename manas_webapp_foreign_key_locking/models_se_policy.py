...
import time
from avi.protobuf.se_policy_pb2 import ServiceEnginePolicy as ServiceEnginePolicyProto

from models_common import Tenant


class ServiceEnginePolicy (models.Model, GenBase):
    pb_class = ServiceEnginePolicyProto
    json = True
    random_uuid = True

    @staticmethod
    def gen_uuid(id=1):
        return 'serviceenginepolicy-%s' % uuid.uuid4()
    ...
    def save(self, update_time=False, *args, **kwargs):
        ...
        super(ServiceEnginePolicy, self).save(*args, **kwargs)
    ...
    def delete(self):
        ...
        super(ServiceEnginePolicy, self).delete()

    def serialize(self):
        return self.protobuf().SerializeToString()

    def _protobuf(self):
        pb = ServiceEnginePolicyProto()
    ...
    tenant_ref = models.ForeignKey(Tenant, null=True, blank=True, related_name="serviceenginepolicy_tenant_ref", on_delete=models.PROTECT)
    se_group_ref_b4f668a3b93a43f7_ref = models.ForeignKey(ServiceEngineGroup, null=True, blank=True, related_name="serviceenginepolicy_se_group_ref_b4f668a3b93a43f7", on_delete=models.PROTECT)
    vrf_ref_93724728901d48fc_ref = models.ForeignKey(VrfContext, null=True, blank=True, related_name="serviceenginepolicy_vrf_ref_93724728901d48fc", on_delete=models.PROTECT)
    nat_policy_ref_b542feabf3dc4f6b_ref = models.ForeignKey(NatPolicy, null=True, blank=True, related_name="serviceenginepolicy_nat_policy_ref_b542feabf3dc4f6b", on_delete=models.PROTECT)
    _last_modified = models.CharField(max_length=16, null=True, blank=True)

    references = {
        'root.se_group_uuid': ('weak_refers_to', u'ServiceEngineGroup', 'b4f668a3b93a43f7'),
        'root.tenant_uuid': ('belongs_to', u'Tenant', 'f56347c1af0f41d8'),
        'root.nat_policy_uuid': ('refers_to', u'NatPolicy', 'b542feabf3dc4f6b'),
        'root.vrf_uuid': ('weak_refers_to', u'VrfContext', '93724728901d48fc'),
    }
    sensitive_fields = {
    }
    pb_check_fields = {
        'root.se_group_uuid': 'f_immutable',

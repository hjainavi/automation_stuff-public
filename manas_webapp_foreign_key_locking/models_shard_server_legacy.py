...
from models_shard_server import *

from models_options_legacy import *
from models_options import *

SHARD_CONSISTENT_HASH = 1
ShardAlgorithmChoices = (
    (SHARD_CONSISTENT_HASH, 'SHARD_CONSISTENT_HASH'),
)
GSLB_DNS_HM_SHARD = 1
POOL_HM_SHARD = 2
ShardTypeChoices = (
    (GSLB_DNS_HM_SHARD, 'GSLB_DNS_HM_SHARD'),
    (POOL_HM_SHARD, 'POOL_HM_SHARD'),
)
